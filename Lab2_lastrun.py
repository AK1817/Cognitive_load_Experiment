...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Public\\Documents\\PsychoPy\\psychopy\\Lab2_lastrun.py',
...
#os.system("C:\\Users\\Public\\Documents\\Psychopy\\psychopy\\\"Brain Workshop\"\\brainworkshop.exe")
time.sleep(1)
...
p.kill()
#os.system("taskkill /IM brainworkshop.exe")
continueRoutine = False
# keep track of which components have finished
